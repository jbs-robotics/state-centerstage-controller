...
@Autonomous(group = "Blue Backdrop", name="BD 15s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueTop15Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueTopBase base = new BlueTopBase(15, drive, hardwareMap, "corner");
