...
@Autonomous(group = "Blue Backdrop", name="BD 5s Middle", preselectTeleOp="Robot-Oriented Drive")
public class BlueTop5Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueTopBase base = new BlueTopBase(5, drive, hardwareMap, "Middle");
