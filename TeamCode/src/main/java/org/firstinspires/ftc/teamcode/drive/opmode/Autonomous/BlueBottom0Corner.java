...
@Autonomous(group = "Blue Stacks", name="BS 0s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom0Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(0, drive, hardwareMap, "corner");
