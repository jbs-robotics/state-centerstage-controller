...
@Autonomous(group = "Red Stack-Side", name="RS 0s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom0Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(0, drive, hardwareMap, "Middle");
