...
@Autonomous(group = "Blue Stacks", name="BS 10s Middle", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom10Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(10, drive, hardwareMap, "Middle");
