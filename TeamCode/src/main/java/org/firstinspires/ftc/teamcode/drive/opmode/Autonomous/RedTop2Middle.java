...
@Autonomous(group = "Red Backdrop", name="RD 2s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedTop2Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(2, drive, hardwareMap, "Middle");
