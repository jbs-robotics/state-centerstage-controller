...
@Autonomous(group = "Blue Backdrop", name="BD 7s Middle", preselectTeleOp="Robot-Oriented Drive")
public class BlueTop7Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueTopBase base = new BlueTopBase(7, drive, hardwareMap, "Middle");
