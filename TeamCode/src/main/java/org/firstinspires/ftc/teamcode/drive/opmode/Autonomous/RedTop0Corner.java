...
@Autonomous(group = "Red Backdrop", name="RD 0s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedTop0Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(0, drive, hardwareMap, "corner");
