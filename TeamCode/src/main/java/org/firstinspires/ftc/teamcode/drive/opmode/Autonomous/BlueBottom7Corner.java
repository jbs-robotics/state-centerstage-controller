...
@Autonomous(group = "Blue Stacks", name="BS 7s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom7Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(7, drive, hardwareMap, "corner");
