...
@Autonomous(group = "Red Stack-Side", name="RS 10s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom10Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(10, drive, hardwareMap, "Middle");
