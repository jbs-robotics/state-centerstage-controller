...
@Autonomous(group = "Red Backdrop", name="RD 0s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedTop0Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(0, drive, hardwareMap, "Middle");
