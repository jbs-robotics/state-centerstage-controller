...
@Autonomous(group = "Blue Stacks", name="BS 7s Middle", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom7Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(7, drive, hardwareMap, "Middle");
