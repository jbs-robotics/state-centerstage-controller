...
@Autonomous(group = "Red Backdrop", name="RD 5s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedTop5Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(5, drive, hardwareMap, "Middle");
