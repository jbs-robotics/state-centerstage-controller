...
@Autonomous(group = "Blue Stacks", name="BS 15s Middle", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom15Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(15, drive, hardwareMap, "Middle");
