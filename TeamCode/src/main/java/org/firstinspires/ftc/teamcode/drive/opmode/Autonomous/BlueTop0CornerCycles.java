...
import org.firstinspires.ftc.teamcode.drive.opmode.Autonomous.BaseAutos.BlueTopBaseCycles;
...
@Autonomous(group = "Blue Backdrop", name="BD 0s Corner (w/ cycles)", preselectTeleOp="Robot-Oriented Drive")
public class BlueTop0CornerCycles extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueTopBaseCycles base = new BlueTopBaseCycles(0, drive, hardwareMap, "corner");
