...
//    public static double LATERAL_DISTANCE = 8.795498861640416; // in; distance between the left and right wheels
    public static double LATERAL_DISTANCE = 8.759; // in; distance between the left and right wheels
//    public static double LATERAL_DISTANCE = 8.762794450175562; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -7.5; // in; offset of the lateral wheel
//    public static double X_MULIPLIER = 1.007298446;
    public static double X_MULIPLIER = .9948245835;
    public static double Y_MULIPLIER = .9890317334;
//    public static double Y_MULIPLIER = 0.9988541352;
