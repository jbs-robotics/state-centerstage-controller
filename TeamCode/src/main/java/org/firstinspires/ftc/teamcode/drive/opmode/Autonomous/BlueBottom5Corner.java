...
@Autonomous(group = "Blue Stacks", name="BS 5s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom5Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(5, drive, hardwareMap, "corner");
