...
@Autonomous(group = "Red Stack-Side", name="RS 0s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom0Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(0, drive, hardwareMap, "corner");
