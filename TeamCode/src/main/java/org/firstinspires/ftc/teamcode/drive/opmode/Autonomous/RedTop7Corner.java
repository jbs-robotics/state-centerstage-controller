...
@Autonomous(group = "Red Backdrop", name="RD 7s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedTop7Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(7, drive, hardwareMap, "corner");
