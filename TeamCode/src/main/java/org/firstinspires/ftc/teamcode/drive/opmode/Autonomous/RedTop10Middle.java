...
import org.firstinspires.ftc.teamcode.drive.opmode.Autonomous.BaseAutos.RedTopBase;
...
@Autonomous(group = "Red Backdrop", name="RD 10s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedTop10Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(10, drive, hardwareMap, "Middle");
