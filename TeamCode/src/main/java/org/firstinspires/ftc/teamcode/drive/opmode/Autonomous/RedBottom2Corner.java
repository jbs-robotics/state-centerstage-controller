...
@Autonomous(group = "Red Stack-Side", name="RS 2s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom2Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(2, drive, hardwareMap, "corner");
