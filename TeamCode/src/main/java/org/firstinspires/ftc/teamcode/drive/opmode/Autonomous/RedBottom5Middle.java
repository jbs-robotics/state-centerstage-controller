...
@Autonomous(group = "Red Stack-Side", name="RS 5s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom5Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(5, drive, hardwareMap, "Middle");
