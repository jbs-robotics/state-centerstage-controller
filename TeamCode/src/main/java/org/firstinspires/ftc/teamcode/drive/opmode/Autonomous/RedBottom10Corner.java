...
import org.firstinspires.ftc.teamcode.drive.opmode.Autonomous.BaseAutos.RedBottomBase;
...
@Autonomous(group = "Red Stack-Side", name="RS 10s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom10Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(10, drive, hardwareMap, "corner");
