...
import org.firstinspires.ftc.teamcode.drive.opmode.Autonomous.BaseAutos.BlueBottomBaseCycles;
...
@Autonomous(group = "Blue Stacks", name="BS 0s Corner (w/ cycles)", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom0CornerCycles extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBaseCycles base = new BlueBottomBaseCycles(0, drive, hardwareMap, "corner");
