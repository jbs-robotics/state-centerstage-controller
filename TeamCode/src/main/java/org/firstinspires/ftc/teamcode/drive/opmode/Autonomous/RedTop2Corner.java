...
@Autonomous(group = "Red Backdrop", name="RD 2s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedTop2Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(2, drive, hardwareMap, "corner");
