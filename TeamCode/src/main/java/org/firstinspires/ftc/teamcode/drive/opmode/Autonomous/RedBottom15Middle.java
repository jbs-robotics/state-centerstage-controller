...
@Autonomous(group = "Red Stack-Side", name="RS 15s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom15Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(15, drive, hardwareMap, "Middle");
