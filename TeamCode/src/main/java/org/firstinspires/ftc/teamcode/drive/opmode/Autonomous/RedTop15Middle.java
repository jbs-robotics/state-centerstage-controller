...
@Autonomous(group = "Red Backdrop", name="RD 15s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedTop15Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(15, drive, hardwareMap, "Middle");
