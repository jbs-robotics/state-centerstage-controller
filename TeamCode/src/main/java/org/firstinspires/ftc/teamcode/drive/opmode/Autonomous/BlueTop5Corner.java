...
@Autonomous(group = "Blue Backdrop", name="BD 5s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueTop5Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueTopBase base = new BlueTopBase(5, drive, hardwareMap, "corner");
