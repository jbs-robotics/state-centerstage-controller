...
@Autonomous(group = "Red Backdrop", name="RD 10s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedTop10Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(10, drive, hardwareMap, "corner");
