...
@Autonomous(group = "Red Backdrop", name="RD 7s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedTop7Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(7, drive, hardwareMap, "Middle");
