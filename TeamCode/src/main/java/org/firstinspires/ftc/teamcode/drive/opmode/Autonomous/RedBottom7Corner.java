...
@Autonomous(group = "Red Stack-Side", name="RS 7s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom7Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(7, drive, hardwareMap, "corner");
