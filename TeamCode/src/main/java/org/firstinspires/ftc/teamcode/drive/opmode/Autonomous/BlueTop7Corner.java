...
@Autonomous(group = "Blue Backdrop", name="BD 7s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueTop7Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueTopBase base = new BlueTopBase(7, drive, hardwareMap, "corner");
