...
@Autonomous(group = "Blue Backdrop", name="BD 2s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueTop2Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueTopBase base = new BlueTopBase(2, drive, hardwareMap, "corner");
