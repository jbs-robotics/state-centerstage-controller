...
@Autonomous(group = "Red Stack-Side", name="RS 5s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom5Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(5, drive, hardwareMap, "corner");
