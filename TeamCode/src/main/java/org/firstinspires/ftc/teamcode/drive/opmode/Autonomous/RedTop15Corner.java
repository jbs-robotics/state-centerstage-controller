...
@Autonomous(group = "Red Backdrop", name="RD 15s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedTop15Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(15, drive, hardwareMap, "corner");
