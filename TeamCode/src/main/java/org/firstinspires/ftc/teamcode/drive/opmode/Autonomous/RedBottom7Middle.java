...
@Autonomous(group = "Red Stack-Side", name="RS 7s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom7Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(7, drive, hardwareMap, "Middle");
