...
@Autonomous(group = "Blue Backdrop", name="BD 15s Middle", preselectTeleOp="Robot-Oriented Drive")
public class BlueTop15Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueTopBase base = new BlueTopBase(15, drive, hardwareMap, "Middle");
