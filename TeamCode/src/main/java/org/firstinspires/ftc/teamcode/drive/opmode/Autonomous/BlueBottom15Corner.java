...
@Autonomous(group = "Blue Stacks", name="BS 15s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom15Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(15, drive, hardwareMap, "corner");
