...
@Autonomous(group = "Blue Stacks", name="BS 2s Middle", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom2Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(2, drive, hardwareMap, "Middle");
