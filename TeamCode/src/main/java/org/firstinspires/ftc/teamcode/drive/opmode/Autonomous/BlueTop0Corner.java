...
@Autonomous(group = "Blue Backdrop", name="BD 0s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueTop0Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueTopBase base = new BlueTopBase(0, drive, hardwareMap, "corner");
