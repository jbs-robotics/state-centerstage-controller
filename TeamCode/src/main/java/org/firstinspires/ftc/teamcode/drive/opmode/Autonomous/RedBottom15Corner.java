...
@Autonomous(group = "Red Stack-Side", name="RS 15s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom15Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(15, drive, hardwareMap, "corner");
