...
@Autonomous(group = "Blue Stacks", name="BS 2s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom2Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(2, drive, hardwareMap, "corner");
