...
@Autonomous(group = "Blue Stacks", name="BS 10s Corner", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom10Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(10, drive, hardwareMap, "corner");
