...
@Autonomous(group = "Red Stack-Side", name="RS 2s Middle", preselectTeleOp="Robot-Oriented Drive")
public class RedBottom2Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedBottomBase base = new RedBottomBase(2, drive, hardwareMap, "Middle");
