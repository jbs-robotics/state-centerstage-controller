...
@Autonomous(group = "Blue Stacks", name="BS 0s Middle", preselectTeleOp="Robot-Oriented Drive")
public class BlueBottom0Middle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueBottomBase base = new BlueBottomBase(0, drive, hardwareMap, "Middle");
