...
@Autonomous(group = "Red Backdrop", name="RD 5s Corner", preselectTeleOp="Robot-Oriented Drive")
public class RedTop5Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedTopBase base = new RedTopBase(5, drive, hardwareMap, "corner");
